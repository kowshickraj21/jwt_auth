...
const Signup = () => {
  ...
  return (
    ...
    <div className='flex m-auto w-1/2 flex-col gap-5 mt-32 border items-center'>
      ...
      <input type="text" name="name" id="name" className='border-2 w-2/3 m-auto h-10 ' onChange={(e) => handleChange(e)} />
      </div>
      <div className='w-2/3'>
      ...
      <button className='border w-1/2 m-auto h-10' onClick={handleSubmit}>Signup</button>
    </div>
    </div>
  )
}
